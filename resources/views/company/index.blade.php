                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        ...
                        @can('create company')
                            <div class="flex items-center mt-4 gap-x-3">
                                <a href="{{ route('company.create') }}" class="flex items-center justify-center w-1/2 px-5 py-2 shadow-lg text-sm tracking-wide text-white transition-colors duration-200 bg-indigo-500 rounded-lg sm:w-auto gap-x-2 hover:bg-indigo-600">Agregar empresa</a>
                            </div>                           
                        @endcan
                    </div>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 ">
                                        <thead class="bg-gray-50 ">
                                            <tr>
                                                ...
                                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 ">Celular</th>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 ">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div>
                                                        <h4 class="text-gray-700 "> {{ $i->email }} </h4>
                                                    </div>
                                                </td>
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <h4 class="text-gray-700"> {{ $i->mobile }} </h4>
                                                    </div>
                                                </td>
